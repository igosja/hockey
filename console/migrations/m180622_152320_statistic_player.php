...
/**
 * Class m180622_152320_statistic_player
 */
class m180622_152320_statistic_player extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable(self::TABLE, [
            ...
            'statistic_player_bullet_win' => $this->integer(2)->defaultValue(0),
            ...
            'statistic_player_game_with_bullet' => $this->integer(2)->defaultValue(0),
