...
class m180619_145934_election_president_vote extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable(self::TABLE, [
            ...
            'election_president_vote_election_president_id' => $this->integer(11)->defaultValue(0),
            'election_president_vote_election_president_application_id' => $this->integer(11)->defaultValue(0),
