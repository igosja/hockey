...
/**
 * Class m180621_184420_rule
 */
class m180621_184420_rule extends Migration
{
    const TABLE = '{{%rule}}';
...
<p class="text-right text-size-3">[<a href="#0">к содержанию</a>]</p>
<p class="text-justify" id="2"><span class="strong">2. Как играть и кто играет?</span> В наш хоккейный менеджер играют через интернет (должен быть доступ на сайт virtual-hockey.org) и электронную почту (у каждого участника игры должен быть работающий почтовый ящик). К участию в Лиге допускаются все желающие, ознакомившиеся с правилами.</p>
<p class="text-right text-size-3">[<a href="#0">к содержанию</a>]</p>
...
<p class="strong text-justify" id="1">1. Общие положения.</p>
<p class="text-justify">1.1. Форум virtual-hockey.org - частный ресурс, часть Виртуальной Хоккейной Лиги. Используя его вы обязуетесь руководствоваться данными Правилами. Нарушители Правил наказываются предупреждениями и могут быть заблокированы временно или навсегда.</p>
