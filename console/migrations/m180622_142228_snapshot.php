...
/**
 * Class m180622_142228_snapshot
 */
class m180622_142228_snapshot extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable(self::TABLE, [
            ...
            'snapshot_basemedical' => $this->decimal(4, 2)->defaultValue(0),
            'snapshot_basephisical' => $this->decimal(4, 2)->defaultValue(0),
            'snapshot_baseschool' => $this->decimal(4, 2)->defaultValue(0),
            'snapshot_basescout' => $this->decimal(4, 2)->defaultValue(0),
            'snapshot_basetraining' => $this->decimal(4, 2)->defaultValue(0),
