...
/**
 * Class m180618_125813_player
 */
class m180618_125813_player extends Migration
{
    const TABLE = '{{%player}}';
    ...
    public function safeUp()
    {
        $this->createTable(self::TABLE, [
            ...
            'player_line_id' => $this->integer(1)->defaultValue(0),
            ...
            'player_rent_day' => $this->integer(3)->defaultValue(0),
            'player_rent_on' => $this->integer(1)->defaultValue(0),
            'player_rent_team_id' => $this->integer(11)->defaultValue(0),
