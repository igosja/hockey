...
$q[] = 'CREATE TABLE `team`
        (
            ...
            `team_base_id` INT(11) DEFAULT 0,
            `team_basemedical_id` INT(11) DEFAULT 0,
            `team_basephisical_id` INT(11) DEFAULT 0,
            `team_baseschool_id` INT(11) DEFAULT 0,
            `team_basescout_id` INT(11) DEFAULT 0,
            `team_basetraining_id` INT(11) DEFAULT 0,
            `team_finance` INT(11) DEFAULT 0,
            ...
            `team_vote_junior` INT(11) DEFAULT 0,
            `team_vote_national` INT(11) DEFAULT 0,
            `team_vote_president` INT(11) DEFAULT 0,
            `team_vote_youth` INT(11) DEFAULT 0
        );';
