...
$q[] = 'CREATE TABLE `game`
        (
            ...
            `game_guest_power_1` SMALLINT(4) DEFAULT 0,
            `game_guest_power_2` SMALLINT(4) DEFAULT 0,
            `game_guest_power_3` SMALLINT(4) DEFAULT 0,
            `game_guest_power_end` SMALLINT(4) DEFAULT 0,
            `game_guest_power_over` SMALLINT(4) DEFAULT 0,
            `game_guest_rudeness_id` TINYINT(1) DEFAULT 0,
            ...
            `game_guest_tacktick_id` TINYINT(1) DEFAULT 0,
            ...
            `game_home_power_1` SMALLINT(4) DEFAULT 0,
            `game_home_power_2` SMALLINT(4) DEFAULT 0,
            `game_home_power_3` SMALLINT(4) DEFAULT 0,
            `game_home_power_end` SMALLINT(4) DEFAULT 0,
            `game_home_power_over` SMALLINT(4) DEFAULT 0,
            `game_home_rudeness_id` TINYINT(1) DEFAULT 0,
            ...
            `game_home_tacktick_id` TINYINT(1) DEFAULT 0,
