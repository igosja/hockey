...
for ($i=1, $count_file_list=count($file_list); $i<=$count_file_list; $i++)
{
    ...
    elseif (24 == $i) { f_igosja_generator_prize(); }
    elseif (25 == $i) { f_igosja_generator_player_game_row(); }
    elseif (26 == $i) { f_igosja_generator_player_tire(); }
    elseif (27 == $i) { f_igosja_generator_training(); }
    elseif (28 == $i) { f_igosja_generator_phisical(); }
    elseif (29 == $i) { f_igosja_generator_school(); }
    elseif (30 == $i) { f_igosja_generator_building_base(); }
    elseif (31 == $i) { f_igosja_generator_building_stadium(); }
    elseif (32 == $i) { f_igosja_generator_decrease_injury(); }
    elseif (33 == $i) { f_igosja_generator_set_injury(); }
    elseif (34 == $i) { f_igosja_generator_make_played(); }
    elseif (35 == $i) { f_igosja_generator_swiss(); }
    elseif (36 == $i) { f_igosja_generator_rent_decrease_return(); }
    elseif (37 == $i) { f_igosja_generator_transfer(); }
    elseif (38 == $i) { f_igosja_generator_rent(); }
    elseif (39 == $i) { f_igosja_generator_player_price_and_salary(); }
    elseif (40 == $i) { f_igosja_generator_player_power_s(); }
    elseif (41 == $i) { f_igosja_generator_player_real_power(); }
    elseif (42 == $i) { f_igosja_generator_team_vs(); }
    elseif (43 == $i) { f_igosja_generator_team_price(); }
    elseif (44 == $i) { f_igosja_generator_user_deprive_team(); }
    elseif (45 == $i) { f_igosja_generator_user_holiday_end(); }
    elseif (46 == $i) { f_igosja_generator_national_vote_status(); }
    elseif (47 == $i) { f_igosja_generator_national_vice_vote_status(); }
    elseif (48 == $i) { f_igosja_generator_national_fire(); }
    elseif (49 == $i) { f_igosja_generator_president_vote_status(); }
    elseif (50 == $i) { f_igosja_generator_president_vice_vote_status(); }
    elseif (51 == $i) { f_igosja_generator_president_fire(); }
    elseif (52 == $i) { f_igosja_generator_site_open(); }
