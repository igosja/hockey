...
for ($i=1, $count_file_list=count($file_list); $i<=$count_file_list; $i++)
{
    ...
    elseif (22 == $i) { f_igosja_generator_player_game_row(); }
    elseif (23 == $i) { f_igosja_generator_player_tire(); }
    elseif (24 == $i) { f_igosja_generator_training(); }
    elseif (25 == $i) { f_igosja_generator_phisical(); }
    elseif (26 == $i) { f_igosja_generator_school(); }
    elseif (27 == $i) { f_igosja_generator_building_base(); }
    elseif (28 == $i) { f_igosja_generator_building_stadium(); }
    elseif (29 == $i) { f_igosja_generator_decrease_injury(); }
    elseif (30 == $i) { f_igosja_generator_set_injury(); }
    elseif (31 == $i) { f_igosja_generator_make_played(); }
    elseif (32 == $i) { f_igosja_generator_swiss(); }
    elseif (33 == $i) { f_igosja_generator_rent_decrease_return(); }
    elseif (34 == $i) { f_igosja_generator_transfer(); }
    elseif (35 == $i) { f_igosja_generator_rent(); }
    elseif (36 == $i) { f_igosja_generator_player_price_and_salary(); }
    elseif (37 == $i) { f_igosja_generator_player_power_s(); }
    elseif (38 == $i) { f_igosja_generator_player_real_power(); }
    elseif (39 == $i) { f_igosja_generator_team_vs(); }
