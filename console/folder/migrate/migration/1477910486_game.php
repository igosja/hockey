...
$q[] = 'CREATE TABLE `game`
        (
            ...
            `game_guest_collision_1` TINYINT(1) DEFAULT 0,
            `game_guest_collision_2` TINYINT(1) DEFAULT 0,
            `game_guest_collision_3` TINYINT(1) DEFAULT 0,
            ...
            `game_guest_power_percent` TINYINT(3) DEFAULT 0,
            `game_guest_rude_1_id` TINYINT(1) DEFAULT 0,
            `game_guest_rude_2_id` TINYINT(1) DEFAULT 0,
            `game_guest_rude_3_id` TINYINT(1) DEFAULT 0,
            ...
            `game_guest_style_1_id` TINYINT(1) DEFAULT 0,
            `game_guest_style_2_id` TINYINT(1) DEFAULT 0,
            `game_guest_style_3_id` TINYINT(1) DEFAULT 0,
            `game_guest_tactic_1_id` TINYINT(1) DEFAULT 0,
            `game_guest_tactic_2_id` TINYINT(1) DEFAULT 0,
            `game_guest_tactic_3_id` TINYINT(1) DEFAULT 0,
            ...
            `game_home_collision_1` TINYINT(1) DEFAULT 0,
            `game_home_collision_2` TINYINT(1) DEFAULT 0,
            `game_home_collision_3` TINYINT(1) DEFAULT 0,
            ...
            `game_home_power_percent` TINYINT(3) DEFAULT 0,
            `game_home_rude_1_id` TINYINT(1) DEFAULT 0,
            `game_home_rude_2_id` TINYINT(1) DEFAULT 0,
            `game_home_rude_3_id` TINYINT(1) DEFAULT 0,
            ...
            `game_home_style_1_id` TINYINT(1) DEFAULT 0,
            `game_home_style_2_id` TINYINT(1) DEFAULT 0,
            `game_home_style_3_id` TINYINT(1) DEFAULT 0,
            `game_home_tactic_1_id` TINYINT(1) DEFAULT 0,
            `game_home_tactic_2_id` TINYINT(1) DEFAULT 0,
            `game_home_tactic_3_id` TINYINT(1) DEFAULT 0,
