...
$q[] = "INSERT INTO `historytext` (`historytext_name`)
        VALUES ('Команда {team} зарегистрирована в Лиге'),
               ...
               ('Пришел из спортшколы в команду {team}'),
               ...
               ('Перешел из команды {team} в команду {team}'),
               ('Перешел из команды {team} в команду {team} в результате обмена'),
               ('Перешел из команды {team} в команду {team} на правах аренды'),
               ('Вернулся в команду {team} из команды {team} по окончании аренды'),
