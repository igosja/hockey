...
function f_igosja_start_insert_user()
{
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='f16aa98974ba943ec95c57bd747d23cc',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='f3dad4cf0afccaa2dcaf999ad60f4501',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='c04e50612b305c3d2b8d588c17d8e237',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='d6419c4d27ca1e68ce3d335718e61695',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='69fb202e9a4d590071c07fd87fd47aae',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='425e6f7f3dbfc2c14f12a388b8ddd81c',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='7ac4953bd13749f9cf8a6c65e38989f6',
                `user_date_confirm`=UNIX_TIMESTAMP(),
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='1e212d4699689eacd061b2c0e9fdaafd',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='affd9c4e181c1638243685a774084af8',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='a2c251fec0f7ccef9001b87a5429550f',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
    ...
    $sql = "INSERT INTO `user`
            SET `user_code`='4b9966a91c8fc1218a08e1d30a524d14',
                `user_date_confirm`=0,
                `user_date_login`=UNIX_TIMESTAMP(),
                `user_date_register`=UNIX_TIMESTAMP(),
