        ...
        $teamArray = [
            [
                ...
                'list' => [
                    ...
                    ['team' => 'Дебрецен', 'stadium' => 'Дебрецен', 'city' => 'Дебрецен'],
                    ['team' => 'Сегед', 'stadium' => 'Сегед', 'city' => 'Сегед'],
                    ['team' => 'Мишкольц', 'stadium' => 'Мишкольц', 'city' => 'Мишкольц'],
                    ['team' => 'Печ', 'stadium' => 'Печ', 'city' => 'Печ'],
                    ['team' => 'Дьёр', 'stadium' => 'Дьёр', 'city' => 'Дьёр'],
                    ['team' => 'Ньиредьхаза', 'stadium' => 'Ньиредьхаза', 'city' => 'Ньиредьхаза'],
                    ['team' => 'Кечкемет', 'stadium' => 'Кечкемет', 'city' => 'Кечкемет'],
                    ['team' => 'Татабанья', 'stadium' => 'Татабанья', 'city' => 'Татабанья'],
                    ['team' => 'Сомбатхей', 'stadium' => 'Сомбатхей', 'city' => 'Сомбатхей'],
                    ['team' => 'Сольнок', 'stadium' => 'Сольнок', 'city' => 'Сольнок'],
                    ['team' => 'Капошвар', 'stadium' => 'Капошвар', 'city' => 'Капошвар'],
                    ['team' => 'Эрд', 'stadium' => 'Эрд', 'city' => 'Эрд'],
                    ['team' => 'Шопрон', 'stadium' => 'Шопрон', 'city' => 'Шопрон'],
                    ['team' => 'Веспрем', 'stadium' => 'Веспрем', 'city' => 'Веспрем'],
                    ['team' => 'Бекешчаба', 'stadium' => 'Бекешчаба', 'city' => 'Бекешчаба'],
                    ['team' => 'Залаэгерсег', 'stadium' => 'Залаэгерсег', 'city' => 'Залаэгерсег'],
                    ['team' => 'Эгер', 'stadium' => 'Эгер', 'city' => 'Эгер'],
                    ['team' => 'Надьканижа', 'stadium' => 'Надьканижа', 'city' => 'Надьканижа'],
                    ['team' => 'Шиофок', 'stadium' => 'Шиофок', 'city' => 'Шиофок'],
                    ['team' => 'Дьюла', 'stadium' => 'Дьюла', 'city' => 'Дьюла'],
                    ['team' => 'Байя', 'stadium' => 'Байя', 'city' => 'Байя'],
                    ['team' => 'Вац', 'stadium' => 'Вац', 'city' => 'Вац'],
                    ['team' => 'Кестхей', 'stadium' => 'Кестхей', 'city' => 'Кестхей'],
                    ['team' => 'Дунакеси', 'stadium' => 'Дунакеси', 'city' => 'Дунакеси'],
                    ['team' => 'Сигетсентмиклош', 'stadium' => 'Сигетсентмиклош', 'city' => 'Сигетсентмиклош'],
                    ['team' => 'Цеглед', 'stadium' => 'Цеглед', 'city' => 'Цеглед'],
                    ['team' => 'Мошонмадьяровар', 'stadium' => 'Мошонмадьяровар', 'city' => 'Мошонмадьяровар'],
                    ['team' => 'Озд', 'stadium' => 'Озд', 'city' => 'Озд'],
                    ['team' => 'Шальготарьян', 'stadium' => 'Шальготарьян', 'city' => 'Шальготарьян'],
                    ['team' => 'Сексард', 'stadium' => 'Сексард', 'city' => 'Сексард'],
                    ['team' => 'Папа', 'stadium' => 'Папа', 'city' => 'Папа'],
                ],
            ],
        ];
