    ...
    public function actionNewFed()
    {
        ...
        $teamArray = [
            [
                'country' => $countryName,
                'list' => [
                    ['team' => 'ИНА', 'stadium' => 'Сисак', 'city' => 'Сисак'],
                    ['team' => 'Загреб', 'stadium' => 'Загреб', 'city' => 'Загреб'],
                    ['team' => 'Медвешчак', 'stadium' => 'Загреб', 'city' => 'Загреб'],
                    ['team' => 'Младост', 'stadium' => 'Загреб', 'city' => 'Загреб'],
                    ['team' => 'Сплит', 'stadium' => 'Сплит', 'city' => 'Сплит'],
                    ['team' => 'Риека', 'stadium' => 'Риека', 'city' => 'Риека'],
                    ['team' => 'Осиек', 'stadium' => 'Осиек', 'city' => 'Осиек'],
                    ['team' => 'Задар', 'stadium' => 'Задар', 'city' => 'Задар'],
                    ['team' => 'Пула', 'stadium' => 'Пула', 'city' => 'Пула'],
                    ['team' => 'Брод', 'stadium' => 'Брод', 'city' => 'Славонски-Брод'],
                    ['team' => 'Карловац', 'stadium' => 'Карловац', 'city' => 'Карловац'],
                    ['team' => 'Вараждин', 'stadium' => 'Вараждин', 'city' => 'Вараждин'],
                    ['team' => 'Шибеник', 'stadium' => 'Шибеник', 'city' => 'Шибеник'],
                    ['team' => 'Винковцы', 'stadium' => 'Винковцы', 'city' => 'Винковцы'],
                    ['team' => 'Горица', 'stadium' => 'Горица', 'city' => 'Велика-Горица'],
                    ['team' => 'Дубровник', 'stadium' => 'Дубровник', 'city' => 'Дубровник'],
                    ['team' => 'Бьеловар', 'stadium' => 'Бьеловар', 'city' => 'Бьеловар'],
                    ['team' => 'Вуковар', 'stadium' => 'Вуковар', 'city' => 'Вуковар'],
                    ['team' => 'Копривница', 'stadium' => 'Копривница', 'city' => 'Копривница'],
                    ['team' => 'Солин', 'stadium' => 'Солин', 'city' => 'Солин'],
                    ['team' => 'Запрешич', 'stadium' => 'Запрешич', 'city' => 'Запрешич'],
                    ['team' => 'Пожега', 'stadium' => 'Пожега', 'city' => 'Пожега'],
                    ['team' => 'Джяково', 'stadium' => 'Джяково', 'city' => 'Джяково'],
                    ['team' => 'Самобор', 'stadium' => 'Самобор', 'city' => 'Самобор'],
                    ['team' => 'Петринья', 'stadium' => 'Петринья', 'city' => 'Петринья'],
                    ['team' => 'Меткович', 'stadium' => 'Меткович', 'city' => 'Меткович'],
                    ['team' => 'Чаковец', 'stadium' => 'Чаковец', 'city' => 'Чаковец'],
                    ['team' => 'Вировитица', 'stadium' => 'Вировитица', 'city' => 'Вировитица'],
                    ['team' => 'Кутина', 'stadium' => 'Кутина', 'city' => 'Кутина'],
                    ['team' => 'Макарска', 'stadium' => 'Макарска', 'city' => 'Макарска'],
                    ['team' => 'Ровинь', 'stadium' => 'Ровинь', 'city' => 'Ровинь'],
                    ['team' => 'Жупанья', 'stadium' => 'Жупанья', 'city' => 'Жупанья'],
                    ['team' => 'Синь', 'stadium' => 'Синь', 'city' => 'Синь'],
                    ['team' => 'Крижевцы', 'stadium' => 'Крижевцы', 'city' => 'Крижевцы'],
                ],
            ],
        ];
