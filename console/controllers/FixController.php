    ...
    public function actionNewFed()
    {
        ...
        $teamArray = [
            [
                'country' => $countryName,
                'list' => [
                    ['team' => 'Санок', 'stadium' => 'Санок', 'city' => 'Санок'],
                    ['team' => 'Тыхы', 'stadium' => 'Тыхы', 'city' => 'Тыхы'],
                    ['team' => 'Ястшембе', 'stadium' => 'Ястор', 'city' => 'Ястшембе-Здруй'],
                    ['team' => 'Краковия', 'stadium' => 'Адам Ковалевский', 'city' => 'Краков'],
                    ['team' => 'Подхале', 'stadium' => 'Подхале', 'city' => 'Новы-Тарг'],
                    ['team' => 'Уния', 'stadium' => 'Освенцим', 'city' => 'Освенцим'],
                    ['team' => 'Орлик', 'stadium' => 'Торополь', 'city' => 'Ополе'],
                    ['team' => 'Напшуд Янув', 'stadium' => 'Хантор Янув', 'city' => 'Катовице'],
                    ['team' => 'Полония', 'stadium' => 'Бытом', 'city' => 'Бытом'],
                    ['team' => 'Катовице', 'stadium' => 'Сподек', 'city' => 'Катовице'],
                    ['team' => 'ТТХ', 'stadium' => 'Тор-Тор', 'city' => 'Торунь'],
                    ['team' => 'Заглембе', 'stadium' => 'МОСиР', 'city' => 'Сосновец'],
                    ['team' => 'Автоматика', 'stadium' => 'Оливия', 'city' => 'Гданьск'],
                    ['team' => 'Криница', 'stadium' => 'Крыница-Здруй', 'city' => 'Крыница-Здруй'],
                    ['team' => 'Легия', 'stadium' => 'Гала Торвар', 'city' => 'Варшава'],
                    ['team' => 'Дембица', 'stadium' => 'Дембица', 'city' => 'Дембица'],
                    ['team' => 'СМС ПЗХЛ', 'stadium' => 'МОСиР', 'city' => 'Сосновец'],
                    ['team' => 'Гданьск', 'stadium' => 'Оливия', 'city' => 'Гданьск'],
                    ['team' => 'Лодзь', 'stadium' => 'Лодзь', 'city' => 'Лодзь'],
                    ['team' => 'Белосток', 'stadium' => 'Белосток', 'city' => 'Белосток'],
                    ['team' => 'Быдгощ', 'stadium' => 'Быдгощ', 'city' => 'Быдгощ'],
                    ['team' => 'Познань', 'stadium' => 'Познань', 'city' => 'Познань'],
                    ['team' => 'Вилки Срэм', 'stadium' => 'Косьцян', 'city' => 'Косьцян'],
                    ['team' => 'Люблин', 'stadium' => 'Люблин', 'city' => 'Люблин'],
                    ['team' => 'Мамуты', 'stadium' => 'Познань', 'city' => 'Познань'],
                    ['team' => 'Орлы', 'stadium' => 'Олесница', 'city' => 'Олесница'],
                    ['team' => 'Мэд Догз', 'stadium' => 'Сопот', 'city' => 'Сопот'],
                    ['team' => 'Золви', 'stadium' => 'Пила', 'city' => 'Пила'],
                    ['team' => 'Кэпиталз', 'stadium' => 'Варшава', 'city' => 'Варшава'],
                    ['team' => 'Вроцлав', 'stadium' => 'Вроцлав', 'city' => 'Вроцлав'],
                    ['team' => 'Вжесня', 'stadium' => 'Вжесня', 'city' => 'Вжесня'],
                    ['team' => 'Хемик', 'stadium' => 'Кендзежин-Козле', 'city' => 'Кендзежин-Козле'],
                    ['team' => 'Недзвядки', 'stadium' => 'Гдыня', 'city' => 'Гдыня'],
                    ['team' => 'Соколы', 'stadium' => 'Торунь', 'city' => 'Торунь'],
                ],
            ],
        ];
