    ...
    public function actionNewFed()
    {
        ...
        $teamArray = [
            [
                'country' => $countryName,
                'list' => [
                    ['team' => 'Готик Д`Амьен', 'stadium' => 'Колизеум', 'city' => 'Амьен'],
                    ['team' => 'Дюк Д`Анже', 'stadium' => 'Эрас', 'city' => 'Анже'],
                    ['team' => 'Боксёр де Бордо', 'stadium' => 'Мериадек', 'city' => 'Бордо'],
                    ['team' => 'Альбатрос де Брест', 'stadium' => 'Ринкла', 'city' => 'Брест'],
                    ['team' => 'Дьябле руж де Бриансон', 'stadium' => 'Рене Фроже', 'city' => 'Бриансон'],
                    ['team' => 'Шамуа де Шамони', 'stadium' => 'Рене Фроже', 'city' => 'Шамони'],
                    ['team' => 'Дюк де Дижон', 'stadium' => 'Тримоле', 'city' => 'Дижон'],
                    ['team' => 'Гамьё Эпиналь', 'stadium' => 'Пуасомпре', 'city' => 'Эпиналь'],
                    ['team' => 'Рапас де Гап', 'stadium' => 'Гап', 'city' => 'Гап'],
                    ['team' => 'Брюлёр де луп де Гренобль', 'stadium' => 'Поль Сюд', 'city' => 'Гренобль'],
                    ['team' => 'Льон де Лион', 'stadium' => 'Шарлемань', 'city' => 'Лион'],
                    ['team' => 'Пингуаин де Морзин', 'stadium' => 'Шкода', 'city' => 'Морзин-Аворьяз'],
                    ['team' => 'Драгон де Руан', 'stadium' => 'Л`Иль Лакруа', 'city' => 'Руан'],
                    ['team' => 'Этуаль нуар де Страсбур', 'stadium' => 'Л`Айсбер', 'city' => 'Страсбур'],
                    ['team' => 'Англет Ормади', 'stadium' => 'Бар', 'city' => 'Англет'],
                    ['team' => 'Драккарс де Кан', 'stadium' => 'Кан ла мер', 'city' => 'Кан'],
                    ['team' => 'Догс де Шоле', 'stadium' => 'Шоле', 'city' => 'Шоле'],
                    ['team' => 'Кокз де Курбевуа', 'stadium' => 'Курбевуа', 'city' => 'Курбевуа'],
                    ['team' => 'Корсарс де Дюнкерк', 'stadium' => 'Мишель Раффу', 'city' => 'Дюнкерк'],
                    ['team' => 'Иглс де Ла-Рош-сюр-Йон', 'stadium' => 'Арго', 'city' => 'Ла-Рош-сюр-Йон'],
                    ['team' => 'Йетис де Монблан', 'stadium' => 'Сен-Жерве', 'city' => 'Сен-Жерве-ле-Бен'],
                    ['team' => 'Скорпионс де Мюлуз', 'stadium' => 'Ильберг', 'city' => 'Мюлуз'],
                    ['team' => 'Корсарс де Нант', 'stadium' => 'Пети-Порт', 'city' => 'Нант'],
                    ['team' => 'Бизонс де Нёйи-сюр-Марн', 'stadium' => 'Нёйи-сюр-Марн', 'city' => 'Нёйи-сюр-Марн'],
                    ['team' => 'Иглс де Нис', 'stadium' => 'Жан-Буен', 'city' => 'Ницца'],
                    ['team' => 'Белугас де Тулуз', 'stadium' => 'Жак Рейно', 'city' => 'Тулуза'],
                    ['team' => 'Рампартс де Тур', 'stadium' => 'Тур', 'city' => 'Тур'],
                    ['team' => 'Букетинс де Мерибель', 'stadium' => 'Мерибель', 'city' => 'Мерибель'],
                    ['team' => 'Аньер Касторс', 'stadium' => 'Аньер', 'city' => 'Аньер-сюр-Сен'],
                    ['team' => 'Жетс де Вири-Шатийон', 'stadium' => 'Лек де Лессон', 'city' => 'Вири-Шатийон'],
                    ['team' => 'Орс де Виллар-де-Ланс', 'stadium' => 'Виллар-де-Ланс', 'city' => 'Виллар-де-Ланс'],
                    ['team' => 'Франсе Воланс', 'stadium' => 'Соня-Хени', 'city' => 'Париж'],
                    ['team' => 'Джокерс де Сержи', 'stadium' => 'Сержи', 'city' => 'Сержи'],
                    ['team' => 'Лионс де Васкеаль', 'stadium' => 'Васкеаль', 'city' => 'Васкеаль'],
                ],
            ],
        ];
