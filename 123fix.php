...
<p class="text-justify">Что это значит? Если встречаются две абсолютно равные по силе команды, то вероятнее всего матч закончится с перевесом в 1-2 шайбы или с овертаймом. Но всегда есть вероятность, что одна из команд в какой-то конкретной игре сможет лучше настроиться на игру и обыграть равного соперника с более уверенной разнице в счёте. Один раз на несколько тысяч подобных матчей победа может быть с разницей в +8.</p>
<p class="text-justify">Такой подход сделан для того, чтобы дать у менеджеров был интерес именно играть, рассчитывая на благосклонность генератора, а не определять результат игры на калькуляторе еще до ее начала.</p>
