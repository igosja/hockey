                ...
                <?php foreach ($name_array as $item) { ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/admin/name/view/<?= $item['name_id']; ?>" class="no-underline">
                                <i class="fa fa-eye fa-fw"></i>
                            </a>
                            <a href="/admin/name/update/<?= $item['name_id']; ?>" class="no-underline">
                                <i class="fa fa-pencil fa-fw"></i>
                            </a>
                            <a href="/admin/name/delete/<?= $item['name_id']; ?>" class="no-underline">
