...
<div class="row">
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
        <select class="form-control form-small" id="questionnaire-country" name="data[name]">
...
<div class="row">
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
        <select class="form-control form-small" id="questionnaire-sex" name="data[name]">
            <option value="0">Не указано</option>
...
<div class="row">
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
        <select class="form-control form-small" id="questionnaire-birth" name="data[name]">
            <option value="0">Не указано</option>
            <?php for ($i=1; $i<=31; $i++) { ?>
                <option
        ...
        <select class="form-control form-small" name="data[name]">
            <option value="0">Не указано</option>
            <?php for ($i=1; $i<=12; $i++) { ?>
                <option
                    <?php if ($i == $user_array[0]['user_birth_day']) { ?>
...
<div class="row">
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-left">
        <input type="checkbox" id="questionnaire-holiday" name="data[name]"/> Назначить заместитетей
    </div>
</div>
<div class="row">
