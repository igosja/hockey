...
/**
 * @var \common\models\Logo[] $logoArray
 * @var \frontend\models\TeamLogo $model
...
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-7 col-sm-8 col-xs-11 team-logo-div">
                <span class="team-logo-link">
                    <?php if (file_exists(Yii::getAlias('@webroot') . '/img/team/125/' . $team->team_id . '.png')) : ?>
                        <?= Html::img(
                            '/img/team/125/' . $team->team_id . '.png?v=' . filemtime(Yii::getAlias('@webroot') . '/img/team/125/' . $team->team_id . '.png'),
                            [
                                'alt' => $team->team_name,
                                'class' => 'team-logo',
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-center">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-7 col-sm-8 col-xs-11 team-logo-div">
                <span class="team-logo-link">
                    <?php if (file_exists(Yii::getAlias('@webroot') . '/upload/img/team/125/' . $team->team_id . '.png')) : ?>
                        <?= Html::img(
                            '/upload/img/team/125/' . $team->team_id . '.png?v=' . filemtime(Yii::getAlias('@webroot') . '/upload/img/team/125/' . $team->team_id . '.png'),
                            [
                                'alt' => $team->team_name,
                                'class' => 'team-logo',
                                'title' => $team->team_name,
