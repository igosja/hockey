...
<?php if ($isVip) : ?>
    ...
    <div class="row margin-top-small div-template-save" style="display: none;">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <?php $form = ActiveForm::begin([
                'action' => ['lineup-national/template-save'],
                'fieldConfig' => [
                    'options' => ['class' => 'row'],
                    'template' =>
    ...
    <div
            ...
            data-url="<?= Url::to(['lineup-national/template']); ?>"
            style="display: none;"
    >
    </div>
<?php endif; ?>
        ...
        $columns = [
            ...
            [
                ...
                'value' => function (Game $model) use ($national) {
                    return $model->game_home_national_id == $national->national_id ? 'Д' : 'Г';
                }
            ],
            [
                'attribute' => 'opponent',
                ...
                'value' => function (Game $model) use ($national) {
                    if ($model->game_home_national_id == $national->national_id) {
                        return $model->nationalGuest->nationalLink(true);
                    } else {
                        return $model->nationalHome->nationalLink(true);
                    }
                }
            ],
            [
            ...
            [
                ...
                'value' => function (Game $model) use ($national) {
                    return Html::a(
                        $model->game_home_national_id == $national->national_id
                            ? ($model->game_home_tactic_id_1 ? '+' : '-')
                            : ($model->game_guest_tactic_id_1 ? '+' : '-'),
                        ['lineup-national/view', 'id' => $model->game_id]
                    );
                }
            ],
        ];
...
<div class="row margin-top">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="row margin-top">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center strong">
                Капитан:
                <i class="fa fa-question-circle-o" title="<table class='table text-center'>
<tr><th>Возраст</th><th>Бонусы и штрафы</th></tr>
<tr><td>38-39</td><td>+8% силы капитана</td></tr>
<tr><td>36-37</td><td>+6% силы капитана</td></tr>
<tr><td>34-35</td><td>+4% силы капитана</td></tr>
<tr><td>32-33</td><td>+2% силы капитана</td></tr>
<tr><td>30-31</td><td>+1% силы капитана</td></tr>
<tr><td>27-29</td><td>бонус отсутствует</td></tr>
<tr><td>25-26</td><td>-1% своей силы</td></tr>
<tr><td>23-24</td><td>-2% своей силы</td></tr>
<tr><td>21-22</td><td>-4% своей силы</td></tr>
<tr><td>19-20</td><td>-6% своей силы</td></tr>
<tr><td>17-18</td><td>-8% своей силы</td></tr>
</table>
<p>Если сила капитана больше, чем средняя сила основного состава с коэффициентом 1.2,
то каждый игрок команды к своей силе получает дополнительно 2% бонуса от силы капитана.
Если сила капитана меньше, чем средняя сила основного состава с коэффициентом 0.8,
то каждый игрок команды к своей силе получает дополнительно 2% штрафа от своей силы.</p>"></i>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            $columns = [
                [
                    ...
                    'contentOptions' => function (Player $model) {
                        if ($model->squadNational) {
                            return ['style' => ['background-color' => '#' . $model->squadNational->squad_color]];
                        }
                        return [];
                    },
                    'footer' => 'Игрок',
...
for ($j = 0; $j <= 5; $j++) {
    ...
    foreach ($fArray as $item) {
        $scriptBody = $scriptBody . '[
            ...
            \'#' . (isset($item['squadNational']) ? $item['squadNational']['squad_color'] : '') . '\'
            ],';
    }
    $scriptBody = $scriptBody . '];';
}
