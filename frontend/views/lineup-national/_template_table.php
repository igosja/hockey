            ...
            <tr>
                ...
                <td class="text-center">
                    <?= Html::a(
                        ...
                        [
                            'class' => 'template-load',
                            'data-url' => Url::to(['lineup-national/template-load', 'id' => $lineupTemplate->lineup_template_id]),
                        ]
                    ); ?>
                    <?= Html::a(
                        ...
                        [
                            ...
                            'data-url' => Url::to(['lineup-national/template-delete', 'id' => $lineupTemplate->lineup_template_id]),
                        ]
                    ); ?>
                </td>
            </tr>
