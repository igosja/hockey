...
<?= Html::beginForm(
    ['olympiad/table', 'seasonId' => $seasonId],
    'get'
); ?>
<div class="row margin-top-small">
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"></div>
        ...
        try {
            $columns = [
                ...
                [
                    ...
                    'value' => function (Olympiad $model) {
                        return $model->olympiad_win_overtime;
                    }
                ],
                [
                    'contentOptions' => ['class' => 'text-center'],
                    ...
                    'value' => function (Olympiad $model) {
                        return $model->olympiad_win_shootout;
                    }
                ],
                [
                    'contentOptions' => ['class' => 'text-center'],
                    ...
                    'value' => function (Olympiad $model) {
                        return $model->olympiad_loose_shootout;
                    }
                ],
                [
                    'contentOptions' => ['class' => 'text-center'],
                    ...
                    'value' => function (Olympiad $model) {
                        return $model->olympiad_loose_overtime;
                    }
                ],
                [
                    'contentOptions' => ['class' => 'text-center'],
                ...
                [
                    ...
                    'value' => function (Olympiad $model): string {
