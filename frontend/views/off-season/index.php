...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        ...
        <p class="text-center">
            <?= Html::a('Турнирная таблица', ['off-season/table', 'seasonId' => $seasonId]); ?>
            |
            <?= Html::a('Статистика', ['off-season/statistics', 'seasonId' => $seasonId]); ?>
        </p>
        <p class="text-justify">
        ...
        <p class="text-justify">
            Каждая команда имеет право сыграть 2 матча на супере и 2 матча на отдыхе во время розыгрыша кубка
            межсезонья.
        </p>
        <p class="text-justify">
