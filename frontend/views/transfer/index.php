    ...
    try {
        $columns = [
            ...
            [
                ...
                'footerOptions' => ['class' => 'col-1 hidden-xs'],
                ...
                'value' => function (Transfer $model) {
                    return Html::a(
                        Html::img(
                            '/img/country/12/' . $model->player->country->country_id . '.png',
                            [
                                'alt' => $model->player->country->country_name,
                                'title' => $model->player->country->country_name,
                            ]
                        ),
                        ['country/news', 'id' => $model->player->country->country_id]
                    );
                }
            ],
            [
            ...
            [
                ...
                'value' => function (Transfer $model) {
                    return Html::a(
                        ...
                        . ')',
                        ['team/view', 'id' => $model->seller->team_id]
                    );
                }
            ],
            [
