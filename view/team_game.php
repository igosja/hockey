            ...
            <?php foreach ($game_array as $item) { ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a class="<?php if ($item['game_home_score'] > $item['game_guest_score']) { ?>success<?php } elseif ($item['game_home_score'] < $item['game_guest_score']) { ?>error<?php } ?>" href="/game_view.php?num=<?= $item['game_id']; ?>">
