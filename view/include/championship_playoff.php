                ...
                <?php foreach ($round['participant'] as $participant) { ?>
                    <tr>
                        <td class="text-right col-35 <?php if (STAGE_FINAL == $round['stage_id']) { ?>col-30-sm<?php } ?>">
                            <a <?php if ($round['stage_id'] == $participant['home_stage_id']) { ?>class="font-red"<?php } ?> href="/team_view.php?num=<?= $participant['home_team_id']; ?>">
                        ...
                        <td>
                            <a <?php if ($round['stage_id'] == $participant['guest_stage_id']) { ?>class="font-red"<?php } ?> href="/team_view.php?num=<?= $participant['guest_team_id']; ?>">
