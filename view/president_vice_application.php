...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <h1>Подача заявки на пост заместителя президента федерации (<?= $country_array[0]['country_name']; ?>)</h1>
    </div>
</div>
<form method="POST">
    ...
    <div class="row margin-top">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <textarea
                ...
                required
                rows="5"
            ><?= (isset($data['text']) ? $data['text'] : (isset($electionpresidentviceapplication_array[0]['electionpresidentviceapplication_text']) ? $electionpresidentviceapplication_array[0]['electionpresidentviceapplication_text'] : '')); ?></textarea>
        </div>
    </div>
    <div class="row">
