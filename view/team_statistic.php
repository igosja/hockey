    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="hidden-xs text-center"><?= $rating_array[0]['ratingteam_visitor_place_division']; ?></td>
            </tr>
            <tr>
                ...
                <td class="hidden-xs text-center"><?= $rating_array[0]['ratingteam_stadium_place_division']; ?></td>
            </tr>
            <tr>
                ...
                <td class="hidden-xs text-center"><?= $rating_array[0]['ratingteam_age_place_division']; ?></td>
            </tr>
            <tr>
                ...
                <td class="hidden-xs text-center"><?= $rating_array[0]['ratingteam_player_place_division']; ?></td>
            </tr>
            <tr>
                ...
                <td class="hidden-xs text-center"><?= $rating_array[0]['ratingteam_power_vs_place_division']; ?></td>
            </tr>
            <tr>
                <td>База:</td>
                ...
                <td class="hidden-xs text-center"><?= $rating_array[0]['ratingteam_base_place_division']; ?></td>
            </tr>
            <tr>
