...
{
    if (TOURNAMENTTYPE_NATIONAL == $game_array[0]['stage_id'])
    {
    ...
    elseif (TOURNAMENTTYPE_LEAGUE == $game_array[0]['stage_id'])
    {
    ...
    elseif (TOURNAMENTTYPE_CHAMPIONSHIP == $game_array[0]['stage_id'])
    {
    ...
    elseif (TOURNAMENTTYPE_CONFERENCE == $game_array[0]['stage_id'])
    {
    ...
    elseif (TOURNAMENTTYPE_OFFSEASON == $game_array[0]['stage_id'])
    {
    ...
    {
        $result = $game_array['tournamenttype_name'];
    }
