...
function f_igosja_game_tournament_link($game_array)
{
    ...
    elseif (TOURNAMENTTYPE_CHAMPIONSHIP)
    {
    ...
    elseif (TOURNAMENTTYPE_CONFERENCE)
    {
    ...
    elseif (TOURNAMENTTYPE_OFFSEASON)
    {
