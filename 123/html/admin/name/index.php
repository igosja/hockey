                ...
                <tr id="filters">
                    <td>
                        <input
                            ...
                            name="filter[name_id]"
                            type="text"
                            value="<?= f_igosja_get('filter', 'name_id'); ?>"
                        />
                    </td>
                    <td>
                        <input
                            ...
                            type="text"
                            value="<?= f_igosja_get('filter', 'name_name'); ?>"
                        >
                    </td>
                    <td></td>
                </tr>
                ...
                <?php foreach ($name_array as $item) { ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="/admin/<?= $route_path; ?>/view/<?= $item['name_id']; ?>" class="no-underline">
                                <i class="fa fa-eye fa-fw"></i>
                            </a>
                            <a href="/admin/<?= $route_path; ?>/update/<?= $item['name_id']; ?>" class="no-underline">
                                <i class="fa fa-pencil fa-fw"></i>
                            </a>
                            <a href="/admin/<?= $route_path; ?>/delete/<?= $item['name_id']; ?>" class="no-underline">
